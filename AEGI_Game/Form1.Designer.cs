namespace AEGI_Game
{
    partial class FormOurGame
    {
        ...
        private void InitializeComponent()
        {
            ...
            // timer
            // 
            timer.Enabled = false; // [Тимур] мы таймер потом в конструкторе отключаем. Зачем здесь его было оставлять в enabled? Отключил, чтобы форма не пыталась тикать до инициализаций
            timer.Interval = 20;
